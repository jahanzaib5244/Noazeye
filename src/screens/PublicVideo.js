            ...
            <View style={{ flexDirection: 'row', position: 'absolute', top: 25, width: '100%' }}>
                ...
                <View style={{ flexDirection: 'row', flex: 2, justifyContent: 'center', alignItems: 'center' }}>
                    <TouchableOpacity onPress={() => navigation.navigate('Private')}>
                        <Text style={{ color: route !== 'Home' ? 'white' : 'gray', fontSize: 20 }}>Private</Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={() => navigation.navigate('Home')}>
                        <Text style={{ color: route == 'Home' ? 'white' : 'gray', fontWeight: '700', fontSize: 20, paddingLeft: 18 }}>Public</Text>
                    </TouchableOpacity>
                </View>
